...
public protocol RemoteBookMarkDataSource {
    func fetchMyBookMarks() -> Single<[MyBookMarkEntity]> // 북마크 그룹 가져오기
    func addBookMark(printShopId: Int, bookmarkGroupId: Int) -> Single<BaseEntity> // 북마크 그룹에 추가하기
    ...
    func renameBookMarkGroup(id:Int, name: String) -> Single<RenameBookMarkEntity>  // 북마크 그룹 이름 수정
